...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-cloumn">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">보험 상품 가입 심사</h1>
                <p class="mb-4">
                    보험 상품 가입 요청을 조회합니다. 심사할 가입 요청을 선택하세요.
                </p>
                        ...
                        <div class="table-responsive" style="overflow-x:auto;">
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="font-size:0.8rem;">
                                ...
                                <c:forEach var="joins" items="${joins}">
                                    <tr>
                                        <td>${joins.myproductid}</td> <!--청구id-->
                                        <td>${joins.userid}</td>
                                        <td>정수일</td>
                                        <td>${joins.insuranceproductid}</td>
                                        <td>${joins.myproductmemberdate}</td>
                                        <td></td>
                                        <td><input type="radio" name="selectedJoin" value="${joins.myproductid}"></td> <!-- 라디오 버튼 -->
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
    ...
    <div id="myModal" class="modal">
        <div class="modal-content">
            <div id="loading" class="loading-div">
                ...
                <p>해당 보험 상품 가입 요청건을 심사 중입니다...</p>
            </div>
            <div id="completed" class="completed-div" style="display:none;">
                <p>심사가 완료되었습니다!</p>
                <button id="reviewJoinButton" class="complete-button" style="margin-top: 10px; margin-bottom: 0px;">
                    심사 결과 확인하기
                </button>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            // reviewJoinButton click logic
            $('#reviewJoinButton').click(function() {
                var selectedJoinId = $('input[name="selectedJoin"]:checked').val();

                if (selectedJoinId) {
                    // AdminController로 데이터를 전달
                    window.location.href = '${pageContext.request.contextPath}/reviewJoin?myproductId=' + selectedJoinId;
                } else {
